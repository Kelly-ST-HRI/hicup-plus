...
Use a text editor to edit the configuration file as required, such as in the following example: ::
    ...
    #Path to the alignment program (Bowtie, Bowtie2, Dragen, or Hisat2)
...
**2)  If necessary, create a Bowtie, Bowtie2, or HISAT2 index or Dragen Hash Table of the Homo sapiens GRCh37 genome (chromosomes 1,...,22, X, Y and MT).**
...
Saumya Agrawal (RIKEN Center for Integrative Medical Sciences, Yokohama, Japan), Yuki Kawasaki (H.U. Group Research Institute, G.K., 
Akiruno, Tokyo, Japan), and Kenichiro Kori (H.U. Group Research Institute, G.K./SRL, Inc., Akiruno, Tokyo, Japan) advised on the 
Hi-C experimental technique and technical biases.
...
The original pipeline is described here:
    ...
    *F1000Research*, **4**:1310; doi: `10.12688/f1000research.7334.1
...
::
    ...
    @Article{pmid26835000,
        ...
        eprint = {https://f1000research.com/articles/4-1310/v1/pdf?article_uuid=1db6bc91-55db-475d-995a-e1eb25cac0f1},
        journal = {F1000Res},
        volume = {4},
        pages = {1310}
    }
